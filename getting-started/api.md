...
| Param | Type | Description |
| :--- | :--- | :--- |
| keysOrPaths | `*` | An array of keys or paths to return, or `db.all` to retrieve them all. |
...
| Param | Type | Description |
| :--- | :--- | :--- |
| keyOrPath | `string` | Either a key, or full path, of the value you want to delete. If providing a path, only the value located at the path is deleted. Alternatively: josh.delete\(josh.all\) will clear the database of all data. |
